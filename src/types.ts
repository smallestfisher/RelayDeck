...
export type UpstreamActionName = 'test-api' | 'test-account' | 'sync-models' | 'refresh-quota' | 'checkin' | 'refresh-all';
export type UpstreamBatchActionName = 'test-api' | 'sync-models' | 'refresh-quota' | 'checkin' | 'refresh-all';
